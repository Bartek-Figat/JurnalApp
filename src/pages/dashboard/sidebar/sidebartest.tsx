...
export const Sidebar = () => {
  ...
  return (
    <div
      className={`lg:min-w-65 h-full min-w-0 transition-all max-md:hidden ${isDarkMode ? "bg-[#151822]" : "bg-white"}`}
    >
      <div
        className={`lg:min-w-65 h-full flex-col border-r border-gray-200 p-6 text-sm font-semibold transition-colors duration-300 max-lg:px-4 ${isDarkMode ? "dark:border-[#212737] dark:bg-[#151822]" : "border-gray-200 bg-white"}`}
      >
